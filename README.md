...
![Open PO Tracker](screenshots/page2_open_po_tracker.pdf)
...
![Three Way Match Exceptions](screenshots/page3_3way_match_exceptions.pdf)

4. **Vendor Scorecard**: Contract status, days to expiry, price variance, and renewal actions for every supplier

![Vendor Scorecard](screenshots/page4_vendor_scorecard.pdf)
